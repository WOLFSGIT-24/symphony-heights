...
const initialData: Record<string, WixDataItem[]> = {
  ...
  gatedlivingbenefits: [
    ...
    },
    {
      ...
      benefitVisual: '/intimate-scale.webp',
      displayOrder: 4,
      isActive: true,
    },
  ],
