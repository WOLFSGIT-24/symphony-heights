...
const initialData: Record<string, WixDataItem[]> = {
  ...
  plotconfigurations: [
    {
      _id: 'plan-1',
      plotName: 'Premium 3 BHK Home (Type A)',
      dimensions: '1818 SQ.FT. SBUA',
      areaSqFt: 1818,
      description: 'Carpet Area: 1174 Sft | Balcony: 118 Sft | Built Up: 1382 Sft | Common: 436 Sft. Designed for open breeze channels and sunlight.',
      availabilityStatus: 'Available',
      plotImage: '/unit-402.png',
    },
    {
      _id: 'plan-2',
      plotName: 'Luxury 3 BHK Home (Type B)',
      dimensions: '1857 SQ.FT. SBUA',
      areaSqFt: 1857,
      description: 'Carpet Area: 1174 Sft | Balcony: 147 Sft | Built Up: 1411 Sft | Common: 446 Sft. Expansive living with oversized private balconies.',
      availabilityStatus: 'Available',
  ...
  projectamenities: [
    {
      _id: 'amenity-1',
      amenityName: 'Ground Level - Arrival & Active Play',
      description: 'Double-height lobby, reflective water cascades, concierge & valet, cricket pitch, pet park, and skating rink.',
    ...
    {
      _id: 'amenity-2',
      amenityName: 'Podium Level - Wellness & Social',
      description: 'High-performance gym, Zen yoga deck with pergola, double-height party hall, indoor games, and al fresco dining.',
    ...
    {
      _id: 'amenity-3',
      amenityName: 'Rooftop Level - Sky Living & Recreation',
      description: 'Infinity lap pool, kids pool, futsal court, double-height badminton court, sky lounge, and stargazing deck.',
    ...
    {
      _id: 'amenity-4',
      amenityName: 'Indoor Games & Entertainment Lounge',
      description: 'Table tennis, billiards, board games lounge, and co-working/WFH tuition booths.',
      galleryImage: '/indoor-games.jpg',
      category: 'Clubhouse',
      displayOrder: 4,
    },
    {
      _id: 'amenity-5',
      amenityName: "Children's Adventure Tot-Lot",
      description: 'Safe rubber-floored outdoor adventure zone with climbing structures, slides, and sensory play spaces.',
      galleryImage: '/kidsplay.jpg',
      category: 'Kids',
      displayOrder: 5,
    },
    {
      _id: 'amenity-6',
      amenityName: 'Celebration Banquet & Party Lawn',
      description: 'Spillover deck with barbecue pods and lawn seating for hosting intimate family gatherings.',
      galleryImage: '/partyhall.jpg',
